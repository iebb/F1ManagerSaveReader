...
const PartStat_TyrePreservation = 2;
...
export const PartCalculationStats2024 = [
  { id: 0, name: 'Top Speed',
    digits: 5,
    bounds: [313, 328],
  ...
  { id: 14, name: 'Tyre Preservation',
    digits: 5,
    bounds: [0, 100],
    render:  (v, d=4) => `${v.toFixed(d)}%`,
    contributors: {
      [PartStat_TyrePreservation]: 1,
    },
  },
...
export const PartStatsCategorized2024 = [
  {
    id: 0,
  ...
  },
  {
    ...
    stats: [
      ...
      {id: "4_15", part: 4, stat: 15, digits: 0, displayDigits: 0,
        ...
        unitValueToValue: x => (x - 1250) * 100 / 275,
      },
    ],
  },
  {
...
export const PSF2024 =  {
  ...
  [PartStat_DragReduction]: {
    ...
    [PartType_Floor]: 0.1,
    [PartType_Suspension]: 0.2
  },
  [PartStat_EngineCooling]: {
    [PartType_Body]: 0.2,
    [PartType_SidePods]: 0.8
  },
  [PartStat_AirFlowMiddle]: {
    [PartType_Body]: 0.7,
    [PartType_SidePods]: 0.3
  },
  [PartStat_DRSDelta]: {
    [PartType_Body]: 0.3,
    [PartType_RearWing]: 0.7
  },
  [PartStat_AirFlowFront]: {
    [PartType_FrontWing]: 0.6,
    [PartType_SidePods]: 0.2,
    [PartType_Suspension]: 0.2
  },
  ...
  [PartStat_TyrePreservation]: {
    [PartType_FrontWing]: 0.2,
    [PartType_Suspension]: 0.8
  },
  [PartStat_LowSpeedDownforce]: {
    [PartType_FrontWing]: 0.5,
    [PartType_RearWing]: 0.1,
    [PartType_Floor]: 0.3,
    [PartType_Suspension]: 0.1
  },
  [PartStat_MedSpeedDownforce]: {
    [PartType_FrontWing]: 0.1,
    [PartType_RearWing]: 0.5,
    [PartType_Floor]: 0.3,
    [PartType_Suspension]: 0.1
  },
